...
function Steps({ userInput, setUserInput,setFinish,setResumeId }) {
  ...
  const steps = ['Basic Information', 'Contact Details', 'Educational Deatails', 'Work Expirience', 'Skills & Certifications', 'Review & submit'];

  const SuggestionSkills = ['Javascript', 'React', 'Node', 'Express', 'Angular', 'MongoDB', 'Git']
